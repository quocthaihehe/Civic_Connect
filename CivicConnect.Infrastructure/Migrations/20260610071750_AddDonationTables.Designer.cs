...
namespace CivicConnect.Infrastructure.Migrations
{
    ...
    [Migration("20260610071750_AddDonationTables")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CivicConnect.Core.Entities.Donation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CivicConnect.Core.Entities.DonationCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CivicConnect.Core.Entities.Policy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PublishedDate = new DateTime(2026, 6, 8, 7, 17, 48, 310, DateTimeKind.Utc).AddTicks(8145),
                            Tag = "Luật mới",
                            TagClass = "tag-law",
                        ...
                        new
                        {
                            ...
                            PublishedDate = new DateTime(2026, 6, 9, 7, 17, 48, 310, DateTimeKind.Utc).AddTicks(8350),
                            Tag = "Thông báo",
                            TagClass = "tag-notice",
                        ...
                        new
                        {
                            ...
                            IsActive = true,
                            IssuingUnit = "UBND Quận 1",
                            PublishedDate = new DateTime(2026, 6, 10, 7, 17, 48, 310, DateTimeKind.Utc).AddTicks(8353),
                            Tag = "Chính sách",
                            TagClass = "tag-policy",
            ...
            modelBuilder.Entity("CivicConnect.Core.Entities.Donation", b =>
                {
                    b.HasOne("CivicConnect.Core.Entities.DonationCategory", "DonationCategory")
                        .WithMany("Donations")
                        .HasForeignKey("DonationCategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CivicConnect.Core.Entities.ApplicationUser", "User")
                        .WithMany()
